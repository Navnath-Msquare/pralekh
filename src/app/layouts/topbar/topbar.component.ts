...
export class TopbarComponent implements OnInit {
  ...
  public _cookiesService: CookieService, public translate: TranslateService, public authService: AuthenticationService, private router: Router,private api: ApiService) { }
  ...
  //   this.api.getNotification(this.authService.currentUserValue.id).subscribe(data=>{
